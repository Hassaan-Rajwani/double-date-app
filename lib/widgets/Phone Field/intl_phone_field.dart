...
import 'package:double_date/widgets/Phone%20Field/countries.dart';
import 'package:double_date/widgets/Phone%20Field/country_picker_dialog.dart';
import 'package:double_date/widgets/Phone%20Field/helpers.dart';
            ...
            children: [
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  validator: (value) {
                    if (value == null && !isNumeric(value!) && value.isEmpty) return validatorMessage;
