...
class BlockUserFromChatDialog extends StatefulWidget {
  const BlockUserFromChatDialog({super.key, required this.conversationId});

  final String conversationId;

  @override
  State<BlockUserFromChatDialog> createState() => _BlockUserFromChatDialogState();
}

class _BlockUserFromChatDialogState extends State<BlockUserFromChatDialog> {
